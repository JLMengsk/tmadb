/*
 * permission relating to Whole_section_images
 */
 ...
 * @author samuelc
 */
class Whole_section_imagesSecurityCheck extends SecurityCheck {
    def params
     ...
     * constructor
     */
    public Whole_section_imagesSecurityCheck(Users user, def params, String currentAction) {
        super(user);
        this.params = params;
     ...
     */
    public Whole_section_imagesSecurityCheck(Users user, def params) {
        super(user);
        this.params = params;
