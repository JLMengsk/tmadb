...
<html>
  ...
  <dojo:header theme="claro" modules="['dojox.grid.DataGrid','dojo.data.ItemFileReadStore','dojo.data.ObjectStore','dojo.store.JsonRest','dojo.store.Observable','dijit.Tree','dijit.tree.dndSource','dijit.form.Form','dijit.form.FilteringSelect','dijit.form.Select','dijit.form.MultiSelect','dijit.form.TextBox','dijit.form.Textarea','dijit.form.ValidationTextBox','dijit.Dialog','dijit.form.CheckBox','dijit.form.RadioButton','dijit.form.NumberTextBox','dijit.form.Button','dijit.form.DropDownButton','dijit.form.DateTextBox','dojo.fx','dijit.layout.TabContainer','dijit.MenuBar','dijit.PopupMenuBarItem','dijit.Menu','dijit.MenuItem']"/>
  <dojo:gridResources/>
<!--   <asset:javascript src="image_helpers/fieldselector.js"/>
  <asset:javascript src="image_helpers/nucleicounter.js"/>
  <asset:javascript src="image_helpers/zoompan.js"/> -->

  <!-- <asset:javascript src="image_helpers"></asset:javascript> -->
